...
void AppModel::CreateBaseButtons() {
	...
	objects.push_back(new TriangleFigure(FIGURE_BUTTON_RECT,
		Vector2f(CENTER_FORM_DEFAULT_POS.x + 18, //TODO: REF
			CENTER_FORM_DEFAULT_POS.y + RECTANGLE_BUTTON_POS_CORRECTION + 25), //TODO: REF
		TRIANGLE_BUTTON_STRING));
	...
	objects.push_back(new CircleFigure(FIGURE_BUTTON_RECT,
		Vector2f(CENTER_FORM_DEFAULT_POS.x + FIGURE_BUTTON_RECT.x + 14, //TODO: REF
			CENTER_FORM_DEFAULT_POS.y + RECTANGLE_BUTTON_POS_CORRECTION + 22), //TODO: REF
		CIRCLE_BUTTON_STRING));
	...
	objects.push_back(new RectangleFigure(FIGURE_BUTTON_RECT,
		Vector2f(CENTER_FORM_DEFAULT_POS.x + FIGURE_BUTTON_RECT.x * GET_HALF + 11, //TODO: REF
			CENTER_FORM_DEFAULT_POS.y + RECTANGLE_BUTTON_POS_CORRECTION + 25), //TODO: REF
		RECTANGLE_BUTTON_STRING));
